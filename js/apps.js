...
export const DEFAULT_APPS = [
  ...
  { id: 'word', name: 'Word', url: 'https://www.microsoft365.com/launch/word', icon: 'icons/apps/word.svg', category: 'core', defaultOrder: 2 },
  { id: 'excel', name: 'Excel', url: 'https://www.microsoft365.com/launch/excel', icon: 'icons/apps/excel.svg', category: 'core', defaultOrder: 3 },
  { id: 'powerpoint', name: 'PowerPoint', url: 'https://www.microsoft365.com/launch/powerpoint', icon: 'icons/apps/powerpoint.svg', category: 'core', defaultOrder: 4 },
  { id: 'onenote', name: 'OneNote', url: 'https://www.microsoft365.com/launch/onenote', icon: 'icons/apps/onenote.svg', category: 'core', defaultOrder: 5 },
  { id: 'onedrive', name: 'OneDrive', url: 'https://onedrive.cloud.microsoft', icon: 'icons/apps/onedrive.svg', category: 'core', defaultOrder: 6 },
  { id: 'sharepoint', name: 'SharePoint', url: 'https://www.microsoft365.com/launch/sharepoint', icon: 'icons/apps/sharepoint.svg', category: 'core', defaultOrder: 7 },
  ...
  { id: 'whiteboard', name: 'Whiteboard', url: 'https://whiteboard.cloud.microsoft', icon: 'icons/apps/whiteboard.svg', category: 'collab', defaultOrder: 10 },
  { id: 'loop', name: 'Loop', url: 'https://loop.cloud.microsoft', icon: 'icons/apps/loop.svg', category: 'collab', defaultOrder: 11 },
  { id: 'clipchamp', name: 'Clipchamp', url: 'https://app.clipchamp.com', icon: 'icons/apps/clipchamp.svg', category: 'collab', defaultOrder: 12 },
  { id: 'sway', name: 'Sway', url: 'https://sway.cloud.microsoft', icon: 'icons/apps/sway.svg', category: 'collab', defaultOrder: 13 },
  ...
  { id: 'dynamics365', name: 'Dynamics 365', url: 'https://www.microsoft365.com/launch/dynamics365', icon: 'icons/apps/dynamics365.svg', category: 'business', defaultOrder: 18 },

  // Planning & Tasks
  { id: 'todo', name: 'To Do', url: 'https://to-do.office.com', icon: 'icons/apps/todo.svg', category: 'planning', defaultOrder: 19 },
  { id: 'planner', name: 'Planner', url: 'https://planner.cloud.microsoft', icon: 'icons/apps/planner.svg', category: 'planning', defaultOrder: 20 },
  ...
  { id: 'm365', name: 'Microsoft 365', url: 'https://m365.cloud.microsoft', icon: 'icons/apps/m365.svg', category: 'other', defaultOrder: 33 },
  { id: 'delve', name: 'Delve', url: 'https://m365.cloud.microsoft/search/overview', icon: 'icons/apps/delve.svg', category: 'other', defaultOrder: 34 },
];
